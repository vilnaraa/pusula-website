  ...
  "entries": [
    {
      ...
      "changed": [
        ...
        "Rüya journal soruları ana formdan çıkarılıp isteğe bağlı kayıt detayına taşındı",
        "Planım ve galeri metinlerindeki eski Ev Modu/dizi-film dili güncel kapsamla değiştirildi"
      ],
      "removed": [
        "Rüya deneyimindeki zorunlu başlık, his ve uyku kalitesi girişleri",
        "Website içeriklerinde kalan eski Ev Modu referansları"
      ]
    },
    {
      "version": "2.1",
    ...
    },
    {
      ...
      "added": [
        ...
        "Hesap bağlantısını kaldırma onayı",
        "Senkronizasyon kapsamı açıklaması",
      ...
      "removed": [
        "Spor sekmesi ve SportsDB entegrasyonu ürün kapsamından çıkarıldı"
      ]
    },
    {
      "version": "0.8",
      ...
      "added": [
        ...
        "60 ruh hali, ton ve ihtiyaç kombinasyonu için otomatik coverage kontrolü",
        "Yakın geçmiş kart hafızası"
      ],
      "changed": [
        "Astro ton doğum tarihi profilinden çıkan burç bilgisine göre kişiselleştirildi",
        "Kart görselleri ana kart ve popup alanlarında daha doğru kırpılacak şekilde ayarlandı"
      ],
      "removed": []
    },
    {
      "version": "0.7",
      "date": "2026-05-31",
      "title": "Planım alanı eklendi",
      "type": "Yeni",
      "summary": "Kullanıcıların günlerini kahve, yemek, etkinlik ve ev modu seçenekleriyle planlaması için yeni alt menü hazırlandı.",
      "added": [
        "Planım alt menüsü",
      ...
      "changed": [
        "Alt menü dört ana alana genişletildi",
        "Platform butonları izleme servislerine doğrudan yönlenecek şekilde ele alındı"
      ],
      "removed": []
    },
    {
      ...
      "added": [
        ...
        "Günlük ritim ve seri takibi",
        "Ruh hali seçimine göre kart yenileme",
        "Bildirim saatini cihazda saklama"
      ],
      "changed": [
        "Uzun journal yaklaşımı yerine tek dokunuşlu günlük check-in akışına geçildi"
      ],
      "removed": [
        "Uzun günlük yazma beklentisi"
      ]
    },
    {
      "version": "0.5",
      "date": "2026-05-25",
      "title": "Güvenli sınırlar ve destek alanı",
      "type": "Güvenlik",
      "summary": "Uygulamanın terapi iddiası taşımaması ve kriz anlarında resmi kaynaklara yönlendirmesi için destek akışları netleştirildi.",
      "added": [
        "Kriz destek kaynakları",
        "112 araması öncesi onay popup'i",
        "3 dakikalık sakinleşme alanı",
        "Yakındaki acil servis yönlendirmesi"
      ],
      "changed": [
        "Ruh hali içerikleri klinik destek değil, refleksiyon diliyle sunuluyor"
      ],
      "removed": []
    },
    {
    ...
    },
    {
      "version": "0.3",
      "date": "2026-05-21",
      "title": "Motion ve görsel sistem ilk pass",
      "type": "Tasarım",
      "summary": "Pusula metaforu için özgün görsel dil, kart davranışları ve giriş ekranı hareketleri çalışıldı.",
      "added": [
        "Pusula hero görseli",
        "Kart detay popup yapısı",
        "Custom tab shell",
        "Pusula kartı metaforuna bağlı görsel setler"
      ],
      "changed": [
        "Standart tab geçişleri custom motion shell ile değiştirildi"
      ],
      "removed": []
    },
    {
      ...
      "changed": [
        "Onboarding ekranları farklı iPhone boyutlarına daha uyumlu hale getirildi"
      ],
      "removed": []
    }
  ]
