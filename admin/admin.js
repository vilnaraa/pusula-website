(function () {
  ...
  const files = {
    site: {
      title: "Site ayarları",
      kicker: "Genel site",
      description: "Hero, SEO, ana odak, Plus ve ürün metinleri burada düzenlenir. Yayına giden ana sayfa metinleri bu dosyadan beslenir.",
      stats: ["SEO", "Hero", "Odak", "Plus"],
      ...
      fields: [
        ...
        ["hero.secondaryCta.label", "Hero ikincil CTA", "input"],
        ["hero.secondaryCta.href", "Hero ikincil CTA linki", "input"],
        ["focus.eyebrow", "Odak üst etiketi", "input"],
        ["focus.title", "Odak başlığı", "textarea"],
        ["focus.description", "Odak açıklaması", "textarea"],
        ["focus.items.0.title", "Odak 1 başlık", "input"],
        ["focus.items.0.label", "Odak 1 etiketi", "input"],
        ["focus.items.0.description", "Odak 1 açıklama", "textarea"],
        ["focus.items.1.title", "Odak 2 başlık", "input"],
        ["focus.items.1.label", "Odak 2 etiketi", "input"],
        ["focus.items.1.description", "Odak 2 açıklama", "textarea"],
        ["focus.items.2.title", "Odak 3 başlık", "input"],
        ["focus.items.2.label", "Odak 3 etiketi", "input"],
        ["focus.items.2.description", "Odak 3 açıklama", "textarea"],
        ["focus.items.3.title", "Odak 4 başlık", "input"],
        ["focus.items.3.label", "Odak 4 etiketi", "input"],
        ["focus.items.3.description", "Odak 4 açıklama", "textarea"],
        ["product.title", "Ürün başlığı", "textarea"],
        ["product.description", "Ürün açıklaması", "textarea"],
        ["product.badge", "Ürün rozeti", "input"],
        ["plus.eyebrow", "Plus üst etiketi", "input"],
        ["plus.title", "Plus başlığı", "textarea"],
        ["plus.description", "Plus açıklaması", "textarea"],
        ["plus.freeTitle", "Ücretsiz kolon başlığı", "input"],
        ["plus.freeItems.0", "Ücretsiz madde 1", "input"],
        ["plus.freeItems.1", "Ücretsiz madde 2", "input"],
        ["plus.freeItems.2", "Ücretsiz madde 3", "input"],
        ["plus.freeItems.3", "Ücretsiz madde 4", "input"],
        ["plus.freeItems.4", "Ücretsiz madde 5", "input"],
        ["plus.plusTitle", "Plus kolon başlığı", "input"],
        ["plus.plusItems.0", "Plus madde 1", "input"],
        ["plus.plusItems.1", "Plus madde 2", "input"],
        ["plus.plusItems.2", "Plus madde 3", "input"],
        ["plus.plusItems.3", "Plus madde 4", "input"],
        ["plus.plusItems.4", "Plus madde 5", "input"],
        ["plus.ctaLabel", "Plus CTA metni", "input"],
        ["plus.ctaHref", "Plus CTA linki", "input"],
